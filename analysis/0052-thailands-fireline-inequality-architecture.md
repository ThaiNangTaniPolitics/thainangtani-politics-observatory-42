...
Thailand’s 2026 haze and wildfire crisis exposes a structural imbalance between **who creates risk**, **who suffers**, and **who fights the fires**.  
While scientific data show that **biomass burning, maize expansion and transboundary smoke** drive PM2.5 levels, the frontline burden falls on **poor, informal volunteer firefighters** in northern highland communities.

This article analyzes:

- the labour economy of volunteer firefighting  
- the mismatch between official narratives and scientific evidence  
...
## 3. The Fireline Labour Economy

Volunteer firefighters in northern Thailand operate as an **informal emergency‑response infrastructure**:
...
They perform tasks normally assigned to state agencies:

- building firebreaks  
- night‑time suppression  
- steep‑slope firefighting  
- smoke‑exposure operations  

This creates a **fireline inequality**:  
**the poorest communities perform the most dangerous work with the least institutional support.**

---

## 4. Institutional Barriers and Governance Asymmetry

Scientific studies highlight that **institutional and social barriers** slow haze‑mitigation efforts more than technical or economic constraints.  
This includes:

- fragmented agency mandates  
- weak budget delivery to villages  
- top‑down burning bans that ignore local ecology  
- criminalization of traditional practices  

Volunteer firefighters remain **unrecognized**, despite being the most effective first responders.

---

## 5. Narrative Politics and Blame‑Shifting

Official narratives often blame:

- hill tribes  
- rotational farmers  
- forest villagers  

Yet NASA and GISTDA data show:

- rotational farming has **weak correlation** with hotspots  
- maize cultivation has **strong correlation** with fire activity  
- haze is **transboundary**, not purely local  

This mismatch between narrative and evidence reinforces **governance asymmetry**.
...
## 7. Transboundary Smoke Dynamics

ASIA‑AQ flight data show:

- smoke layers above the boundary layer  
- long‑range transport from Myanmar and Laos  
- regional fire synchronisation  

This means Thailand’s haze crisis is **regional**, not solely domestic.

---

## 8. Structural Inequality in Fire Management

Forest communities:

- pay for fuel, tools, repairs  
- build firebreaks without state support  
- face arrests under zero‑burning policies  
- are blamed for fires they did not cause  

Meanwhile:

- industrial burning receives less scrutiny  
...
- **Geographic layer:** Mountainous terrain amplifies fire spread and smoke entrapment.  
